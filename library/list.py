Problems = [
    {
        ...
        "description": "Tạo một chương trình với đầu vào là tên và tuổi của 1 người. In ra một thông báo cho biết năm người đó sẽ tròn 100 tuổi. Giả sử năm hiện tại là năm 2021. Thông báo in ra dạng: <name> will be 100 years old in the year <year>",
    ...
    },
    {
        ...
        "description": "Đối với bài tập này, chúng ta sẽ theo dõi ngày sinh của một người và có thể tìm thấy thông tin đó dựa trên tên của họ. Tạo một từ điển về tên và ngày sinh:'Albert Einstein': '03/14/1879', 'Benjamin Franklin': '01/17/1706', 'Ada Lovelace': '12/10/1815', 'Donald Trump': '06/14/1946', 'Rowan Atkinson': '01/6/1955' .Đầu vào của chương trình là tên và in ra ngày sinh của người đó '<name>'s birthday is <birthday>.'. Nếu không có trong từ điển 'Sadly, we don't have <name>'s birthday.'",
