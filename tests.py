...
# Exercise 11: Birthday Dictionaries
...
#------------------------------MIMGO------------------------------
# Exercise 12: Calculate variance
#Medium
def mean(s):                    
    sum = 0
    for i in s:
...
class compare_check(unittest.TestCase):
    def test_1(self):
        assert correct_compare("rock","scissors")  == compare("rock","scissors") 
    def test_2(self):
    ...
    def test_5(self):
        assert correct_compare("a","b")  == compare("a","b")
...
class divisors_check(unittest.TestCase):
    ...
    def test_4(self):
        assert correct_divisors(100) == divisors(100)
...
'''class pwd(unittest.TestCase):
    def test_1(self):
        password = "k{aDK5yPq"
        assert correct_pwd(password) == pwd(password)
    def test_2(self):
        password = "XHhFCgwzb"
        assert correct_pwd(password) == pwd(password)
    def test_3(self):
...
class birthdayDic_check(unittest.TestCase):
    ...
    def test_3(self):
        assert correct_birthdayDic("Rowan Atkinson") == birthdayDic("Rowan Atkinson")
    def test_4(self):
...
class dec5_check(unittest.TestCase):
    ...
    def test_4(self):
        assert correct_dec5("0011,0110,1001,1000") == dec5("0011,0110,1001,1000")
